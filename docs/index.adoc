...
Standards:: image:https://img.shields.io/badge/standard-PFLR1-orange.svg["Pitchfork Layout R1", link="https://github.com/vector-of-bool/pitchfork"]
...
Tests:: image:https://travis-ci.com/bfgroup/Lyra.svg?branch=master["Travis", link="https://travis-ci.com/bfgroup/Lyra"]
