...
* Tested with
	Visual Studio 2015, VS 2017, VS2019,
	MinGW-64 (gcc 8.1),
	Linux (clang 3.5, 3.6, 3.7, 3.8, 3.9, 4, 5, 6, 7, 8; gcc 4.8, 4.9, 5, 6, 7, 8, 9),
	Xcode (9.0, 9.0.1, 9.1, 9.2, 9.3, 9.3.1, 9.4, 9.4.1, 10.0, 10.1, 10.2, 10.2.1),
	on Azure Pipelines.
