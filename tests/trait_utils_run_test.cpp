...
int main()
{
...

	{
		test(REQUIRE((!lyra::detail::is_callable<int, int>::value)))(
			REQUIRE((!lyra::detail::is_callable<float, int, int>::value)))(
			REQUIRE((!lyra::detail::is_callable<std::string, int>::value)));
	}
	{
		...
		test(REQUIRE((lyra::detail::is_callable<decltype(f0)>::value)))(
			REQUIRE((lyra::detail::is_callable<decltype(f1), int>::value)))(
			REQUIRE(
...

	{
		test(REQUIRE((!lyra::detail::is_invocable<int>::value)))(
			REQUIRE((!lyra::detail::is_invocable<float>::value)))(
			REQUIRE((!lyra::detail::is_invocable<std::string>::value)));
	}
	{
		auto f0 = []() -> bool { return false; };
		auto f1 = [](int x) -> bool { return x > 1; };
		...
		test(REQUIRE((lyra::detail::is_invocable<decltype(f0)>::value)))(
			REQUIRE((lyra::detail::is_invocable<decltype(f1)>::value)))(
			REQUIRE((lyra::detail::is_invocable<decltype(f2)>::value)));
	}
	{
		test(REQUIRE(is_invocable_v([]() -> bool { return false; })))(
			REQUIRE(is_invocable_v([](int x) -> bool { return x > 1; })))(
			REQUIRE(
